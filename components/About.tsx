        ...
        <main>
            <div className="group container flex justify-between mx-auto px-8 md:px-14 lg:px-24 w-full">
                <section className="w-full">
                    <h1 id="about-me" className={`text-${props.colorScheme}-red md:group-hover:text-primary duration-300 ease-in transition pt-4 text-3xl text-primary-dim`}>about me</h1>
                    <div className="group-hover:text-secondary text-secondary-dim duration-300 ease-in transition">
                        <p className="text-ctp-text text-xl w-full my-6"> I&apos;m a software engineer at Change Healthcare currently
                        ...
                        <p className="text-ctp-text text-xl w-full my-6">
                        ...
                        <p className="text-ctp-text text-xl w-full my-6"> Outside of programming, I like to be really active. I&apos;m
